...
@keyframes blobFloat {
  ...
  70%      { transform: translateY(10px)  scale(.97); }
}
.blob-1 { animation-name: blobFloat1; }
@keyframes blobFloat1 {
  0%,100% { transform: translate(0,0) scale(1); }
  40%     { transform: translate(-16px,-22px) scale(1.05); }
...
.pwd-toggle {
  ...
  color: #c89ab0; font-size: 15px;
  padding: 4px; line-height: 1;
  transition: color .2s;
}
.pwd-toggle:hover { color: #e91e8c; }
...
.btn-login:hover         { transform: translateY(-1px); box-shadow: 0 10px 28px rgba(233,30,140,.36); }
...
.dots span:nth-child(2) { background: rgba(255,255,255,.5); width: 20px; border-radius: 3px; }
</style>
</head>
<body>
