...
<head>
  ...
  <meta name="description" content="@yield('meta_desc', 'Maw Maw Donut — Donat lezat dengan beragam topping kekinian.')">
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ */
    ...
    /* ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
   UTILITIES (dipakai di sub-views)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━ */
    .btn-pink {
      display: inline-flex;
      align-items: center;
...
<body>
  ...
  @php
  $profile = $profile ?? \App\Models\ProfilePerusahaan::first();
  $waNumber = preg_replace('/\D/', '', $profile->telepon ?? '081528844756');
  @endphp
  ...
  <nav class="navbar" id="navbar">
    ...
    <a class="logo-wrap" href="{{ route('beranda') }}">
      ...
      <img class="logo-img" src="{{ Storage::url($profile->logo) }}"
        ...
        width="46" height="46" loading="eager">
      @else
    ...
    <div class="nav-links">
      ...
      <a href="{{ route('tentang') }}"
        class="{{ request()->routeIs('tentang') ? 'active' : '' }}">Tentang Kami</a>
      <a href="{{ route('katalog') }}"
        class="{{ request()->routeIs('katalog') ? 'active' : '' }}">Katalog</a>
    ...
    <div class="mobile-nav" id="mobileNav" role="navigation" aria-label="Menu mobile">
      <a href="{{ route('beranda') }}"
        ...
        <i class="fa-solid fa-house" style="color:var(--pink);width:18px;"></i> Beranda
      </a>
      <a href="{{ route('profil') }}"
        class="{{ request()->routeIs('profil') ? 'active' : '' }}">
        <i class="fa-solid fa-user" style="color:var(--pink);width:18px;"></i> Profil
      </a>
      <a href="{{ route('tentang') }}"
        class="{{ request()->routeIs('tentang') ? 'active' : '' }}">
        <i class="fa-solid fa-circle-info" style="color:var(--pink);width:18px;"></i> Tentang Kami
      </a>
      <a href="{{ route('katalog') }}"
        class="{{ request()->routeIs('katalog') ? 'active' : '' }}">
        <i class="fa-solid fa-shop" style="color:var(--pink);width:18px;"></i> Katalog Produk
      </a>
      <a href="https://wa.me/{{ $waNumber }}" target="_blank" rel="noopener"
        style="color:var(--pink);">
        <i class="fa-brands fa-whatsapp" style="width:18px;"></i> Pesan via WhatsApp
      </a>
    </div>
  ...
  <footer>
    <div class="footer-grid">
      ...
      <div class="footer-col">
        ...
        <p class="footer-desc">
          {{ Str::limit($profile->deskripsi ?? 'Brand lokal yang menyajikan kebahagiaan lewat donat lembut dengan beragam topping kekinian.', 120) }}
        </p>
      ...
      <div class="footer-col">
        <h4>Navigasi</h4>
        <a class="fc-item" href="{{ route('beranda') }}">
          <i class="fa-solid fa-chevron-right"></i><span>Beranda</span>
        </a>
        <a class="fc-item" href="{{ route('tentang') }}">
          <i class="fa-solid fa-chevron-right"></i><span>Tentang Kami</span>
        </a>
        <a class="fc-item" href="{{ route('katalog') }}">
          <i class="fa-solid fa-chevron-right"></i><span>Katalog Produk</span>
        </a>
        <a class="fc-item" href="{{ route('login') }}">
          <i class="fa-solid fa-chevron-right"></i><span>Login Admin</span>
        </a>
      </div>
    ...
    <div class="footer-bottom">
      &copy; {{ date('Y') }} {{ $profile->nama_perusahaan ?? 'Maw Maw Donut' }}.
      All rights reserved.
      &nbsp;·&nbsp;
