...
<style>
    ...
    .produk-hero::after {
        ...
        position: absolute;
        inset: 0;
        background: linear-gradient(135deg, rgba(242, 117, 117, .75), rgba(255, 179, 186, .55));
        z-index: 1
    }
    ...
    .search-input:focus {
        ...
        box-shadow: 0 0 0 3px rgba(242, 117, 117, .12)
    }
    ...
    .produk-card:hover {
        ...
        box-shadow: 0 14px 36px rgba(242, 117, 117, .15)
    }
    ...
    .produk-card-name mark {
        background: rgba(242, 117, 117, .18);
        color: var(--pink-dark);
        border-radius: 3px;
        padding: 0 2px;
    }
    ...
    .produk-card:hover .produk-card-btn {
        background: var(--pink);
        color: #fff
    }
