...
<style>
    ...
    /* ═══ PROFIL PERUSAHAAN ═══ */
    .profil-section {
        background: linear-gradient(135deg, #fff0f5 0%, #fff9fb 60%, #fff0f5 100%);
        padding: 80px 6%
    }
    ...
    .timeline::before {
        ...
        bottom: 0;
        width: 2px;
        background: linear-gradient(to bottom, transparent, var(--pink-light), var(--pink), var(--pink-light), transparent);
