...
<style>
    ...
    .katalog-hero::after {
        ...
        position: absolute;
        inset: 0;
        background: linear-gradient(135deg, rgba(242, 117, 117, .78) 0%, rgba(255, 179, 186, .55) 100%);
        z-index: 1
    }
    ...
    .card-img-placeholder {
        height: 200px;
        background: linear-gradient(135deg, #fce4ec, var(--pink-pale));
        display: flex;
        align-items: center;
